...
void sendBrewEvent(float inputPressure, float setPressure, float pumpFlowRate, float setPumpFlowRate, float weightBrewed, int DimmerPower) {
    StaticJsonDocument<96> doc;
