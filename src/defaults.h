...
#define FEATURE_BREW_CONTROL                  1      // enables function to control pump and solenoid valve
#define FEATURE_FULLSCREEN_BREW_TIMER         1      // enables full screen brew timer
#define FEATURE_FULLSCREEN_MANUAL_FLUSH_TIMER 1      // enables full screen manual flush timer
