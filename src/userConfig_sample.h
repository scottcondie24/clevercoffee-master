...
#define FEATURE_WATER_LED     2                       // Turn on hot water LED when switch is started, 0 = deactivated, 1 = activated, 2 = activated inverted
#define FEATURE_STEAM_LED     2                       // Turn on steam LED when switch is started, 0 = deactivated, 1 = activated, 2 = activated inverted
...
#define FEATURE_PRESSURESENSOR 0                      // 0 = deactivated, 1 = activated i2c, 2 = activated analog
...
#define TEMP_SENSOR 3  // Temp sensor type: 1 = DS18B20, 2 = TSIC306, 3 = MAX6675
